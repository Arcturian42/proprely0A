    ...
    <AdminLayout>
      <div className="p-8">
        <PageHeader
          ...
          action={
            <Button onClick={() => { setForm({ client_id: '', site_id: '', scheduled_date: '', start_time: '', planned_hours: '2', sop_id: '', notes: '', priority: 'normale', service_type: '' }); setSelectedAgents([]); setShowForm(true) }} className="gap-2">
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="grid gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <Label>Durée (h)</Label>
                <Input type="number" min="0.5" step="0.5" value={form.planned_hours} onChange={e => setForm(f => ({ ...f, planned_hours: e.target.value }))} />
              </div>
              <div>
              ...
              <div className="space-y-2 border rounded-lg p-3">
                {agents.map(agent => (
                  <div key={agent.id} className="flex items-center gap-3">
                    ...
                    <label htmlFor={`plan-${agent.id}`} className="text-sm cursor-pointer flex-1">
